    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_add"> Tambah Kategori Pemasukan</button>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php 
                                            $counter = 0;
                                            foreach($data_kategori_pemasukan as $row):
                                                $counter += 1;
                                        ?>
                                            <tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="myLargeModalLabel">Tambah Kategori Pemasukan</h5>
                ...
                <form action="#" id="form_modal_add" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="text-align: right">
                            <button type="button" class="btn btn-primary ml-3" id="btn-simpan" data-object="<?= base_url('kategori_transaksi_finance/add/pemasukan') ?>">
                                Simpan
                            </button>
                        </div>
                    </div>
...
<div id="modal_edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="myLargeModalLabel">Edit Kategori Pemasukan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script>
    ...
    function reloadMainDatatable(filterList) {
        fetch(`${baseUrl}/kategori_transaksi_finance/ajax_get/main_table_data/pemasukan`, {
            method: 'POST',
            headers: {
    ...
    $(document).on('click', '#btn-simpan', function () {
        ...
        loadSaveSwal(path, data, 'Tambah Kategori Pemasukan?', 'Disimpan!', 'Kategori pemasukan baru berhasil disimpan.', 'modal_add');
    });
    ...
    $(document).on('click', '#btn-simpan-edit', function () {
        ...
        loadSaveSwal(path, data, 'Edit Kategori Pemasukan?', 'Disimpan!', 'Kategori pemasukan berhasil diedit.', 'modal_edit');
    });
    ...
    $(document).on('click', '#btn_delete', function () {
        ...
        loadSaveSwal(path, data, 'Hapus Kategori Pemasukan\n '+thisData['nama']+' ?', 'Dihapus!', 'Kategori pemasukan '+thisData['nama']+' \nberhasil dihapus.', '');
    });
