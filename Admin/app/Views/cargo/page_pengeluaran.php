...
<script>
    ...
    function mainDatatable() {
        ...
        mainTable = $('#main_table').DataTable({
            ...
            ajax: {
                "url": "<?php echo site_url('cargo/ajax_get_pengeluaran')?>",
                "type": "POST",
                "data": function ( data ) {
    ...
    $(document).on('click', '#btn_simpan', function () {
        ...
        const path = "<?= base_url('cargo/add_pengeluaran') ?>";
        const data = {
    ...
    $(document).on('click', '#btn_edit', function() {
        ...
        const path = "<?= site_url('cargo/ajax_get_pengeluaran_data') ?>";
    ...
    $(document).on('click', '#btn_konfirmasi_edit', function () {
        const path = "<?= base_url('cargo/edit_pengeluaran') ?>";
        const data = {
            id_edit : $('#id_edit').val(),
    ...
    $(document).on('click', '#btn_delete', function () {
        const thisData = $(this).data();
        const path = "<?= site_url('cargo/delete_pengeluaran') ?>";
        const data = {
            id : thisData['id']
        };
