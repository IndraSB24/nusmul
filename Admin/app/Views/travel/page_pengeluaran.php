    ...
    <?= $this->include('partials/body') ?>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-light" id="myLargeModalLabel">Tambah Pengeluaran</h5>
        ...
        <div id="modal_edit" class="modal fade" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-light" id="myLargeModalLabel">Edit Data Pengeluaran</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
...
<script>
    ...
    function mainDatatable() {
        ...
        mainTable = $('#main_table').DataTable({
            ...
            ajax: {
                "url": "<?php echo site_url('travel/ajax_get_pengeluaran')?>",
                "type": "POST",
                "data": function ( data ) {
    ...
    $(document).on('click', '#btn_simpan', function () {
        ...
        const path = "<?= base_url('travel/add_pengeluaran') ?>";
        const data = {
        ...
        loadQuestionalSwal(
            path, data, 'Tambah pengeluaran ?', 
            'Ditambahkan!', 'pengeluaran berhasil ditambahkan', 'modal_add'
        );
    });
    ...
    $(document).on('click', '#btn_edit', function() {
        ...
        const path = "<?= site_url('travel/ajax_get_pengeluaran_data') ?>";
    ...
    $(document).on('click', '#btn_konfirmasi_edit', function () {
        const path = "<?= base_url('travel/edit_pengeluaran') ?>";
        const data = {
            id_edit : $('#id_edit').val(),
        ...
        loadQuestionalSwal(
            path, data, 'Edit pengeluaran ?', 
            'Diedit!', 'pengeluaran berhasil diedit', 'modal_edit'
        );
    });
    ...
    $(document).on('click', '#btn_delete', function () {
        const thisData = $(this).data();
        const path = "<?= site_url('travel/delete_pengeluaran') ?>";
        const data = {
            id : thisData['id']
        };
        
        loadQuestionalSwal(
            path, data, 'Hapus pengeluaran dengan kode: '+thisData['kode']+' ?', 
            'Dihapus!', 'pengeluaran dengan kode: '+thisData['kode']+' berhasil dihapus.', ''
        );
    });
