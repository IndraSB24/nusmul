...
class Model_travel_pengeluaran extends Model
{
    protected $table      = 'travel_pengeluaran';
    ...
    public function get_datatable_main()
    {
        ...
        $column_searchable = [
            'travel_pengeluaran.for_date'
        ];
        $column_orderable = [
            'travel_pengeluaran.id', 'travel_pengeluaran.for_date'
        ];
        ...
        ')
        ->join('customer c', 'c.id=travel_pengeluaran.id_customer', 'LEFT')
        ->join('armada a', 'a.id=travel_pengeluaran.id_armada', 'LEFT')
        ->where('travel_pengeluaran.deleted_at', NULL);
