...
class Model_cargo_pengeluaran extends Model
{
    protected $table      = 'cargo_pengeluaran';
    ...
    protected $allowedFields = [
        'id_customer', 'id_armada', 'description', 'for_date', 'quantity', 'unit', 'amount_per_unit',
    ...
    public function get_datatable_main()
    {
        ...
        $column_searchable = [
            'cargo_pengeluaran.for_date'
        ];
        $column_orderable = [
            'cargo_pengeluaran.id', 'cargo_pengeluaran.for_date'
        ];
        ...
        ')
        ->join('customer c', 'c.id=cargo_pengeluaran.id_customer', 'LEFT')
        ->join('armada a', 'a.id=cargo_pengeluaran.id_armada', 'LEFT')
        ->where('cargo_pengeluaran.deleted_at', NULL);
