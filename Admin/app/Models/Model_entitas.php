...
class Model_entitas extends Model
{
    ...
    protected $allowedFields = [ 'nama', 'deskripsi', 'kode_provinsi', 'kode_kota', 'alamat', 'id_service' ];
    ...
    {
        $sql = "ALTER TABLE entitas AUTO_INCREMENT=1";
        $this->db->query($sql);
    }
