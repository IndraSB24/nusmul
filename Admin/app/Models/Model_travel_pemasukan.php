...
class Model_travel_pemasukan extends Model
{
    protected $table      = 'travel_pemasukan';
    ...
    public function get_datatable_main()
    {
        ...
        $column_searchable = [
            'travel_pemasukan.for_date'
        ];
        $column_orderable = [
            'travel_pemasukan.id', 'travel_pemasukan.for_date'
        ];
        ...
        ')
        ->join('customer c', 'c.id=travel_pemasukan.id_customer', 'LEFT')
        ->join('armada a', 'a.id=travel_pemasukan.id_armada', 'LEFT')
        ->where('travel_pemasukan.deleted_at', NULL);
