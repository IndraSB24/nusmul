...
class Model_bus_pemasukan extends Model
{
    protected $table      = 'bus_pemasukan';
    ...
    public function get_datatable_main()
    {
        ...
        $column_searchable = [
            'bus_pemasukan.for_date'
        ];
        $column_orderable = [
            'bus_pemasukan.id', 'bus_pemasukan.for_date'
        ];
        ...
        ')
        ->join('customer c', 'c.id=bus_pemasukan.id_customer', 'LEFT')
        ->join('armada a', 'a.id=bus_pemasukan.id_armada', 'LEFT')
        ->where('bus_pemasukan.deleted_at', NULL);
