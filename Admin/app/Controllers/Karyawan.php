...
class Karyawan extends BaseController
{
    ...
    protected $model_karyawan, $model_nusmul_service;
	...
	public function index()
	{
		...
		$data = [
			...
			'data_karyawan' => $this->model_karyawan->getAllRaw(),
			'data_nusmul_service' => $this->model_nusmul_service->findAll(),
			'data_list_posisi' => $this->model_list_posisi->findAll()
		];
		
		return view('data_master/karyawan', $data);
	}
